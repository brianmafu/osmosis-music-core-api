...
from music_core.serializers import (AdminSerializer, AdsSettingsSerializer,
                                    AlbumSerializer,
                                    ApiListParametersSerializer,
                                    ApiListSerializer, ArtistSerializer,
                                    BannerSliderSerializer, CategorySerializer,
                                    HomeComponentsSerializer, LikedSerializer,
                                    MovieSerializer, MusicSerializer,
                                    NotificationSettingsSerializer,
                                    PackageSettingsSerializer,
                                    PaymentMethodSerializer,
                                    RecentlyViewSerializer,
                                    SettingsFlagSerializer,
                                    UserPaymentSerializer,
                                    UserPlaylistMusicSerializer,
                                    UserPlaylistSerializer, UserSerializer)
